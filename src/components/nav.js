...
// import logo from '../logo.svg';
	...
	const Nav = () => {
		...
		const checkRoute = () => {	
			const active = document.querySelectorAll('ul.nav a.iconSwitch')
		...
		return ( 
			...
			<nav id="primary-nav">
				<ul className="nav">
					<Link to='/' className="iconSwitch" onMouseOut={checkRoute}>
					...
					<Link to='/projects' className='iconSwitch' onMouseOut={checkRoute}>
								<FontAwesomeIcon 
									className='nav-item'
									icon='tasks' 
									size="lg"/> 
					...
					<Link to='/skills' className='iconSwitch' onMouseOut={checkRoute}>
								<FontAwesomeIcon 
									className='nav-item'
									icon='toolbox' 
									size="lg"/> 
					...
					<Link to='/about' className='iconSwitch' onMouseOut={checkRoute}>
								<FontAwesomeIcon
									className='nav-item'
									icon='user' 
									size="lg"/> 
